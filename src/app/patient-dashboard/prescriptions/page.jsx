          ...
          <div className="flex justify-between items-center">
            ...
            <div className="text-right">
              ...
              <div className="text-blue-100 mt-1">
                {new Date(selectedPrescription.date).toLocaleDateString('en-US', { weekday: 'long' })}
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-h-[200px] overflow-y-auto p-6 bg-white">
            <ul className="space-y-3 text-sm text-amber-800">
              <li className="flex items-start">
                ...
                <span><strong>Instructions:</strong> {selectedPrescription.instructions || "Take as directed by physician"}</span>
              </li>
              <li className="flex items-start">
                <span className="w-1.5 h-1.5 bg-amber-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                <span><strong>Storage:</strong> Keep at room temperature away from moisture</span>
              </li>
              <li className="flex items-start">
                <span className="w-1.5 h-1.5 bg-amber-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                <span><strong>Side Effects:</strong> May cause dizziness or nausea</span>
              </li>
              <li className="flex items-start">
                <span className="w-1.5 h-1.5 bg-amber-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                <span><strong>Refills:</strong> {selectedPrescription.refills} remaining</span>
              </li>
              <li className="flex items-start">
                <span className="w-1.5 h-1.5 bg-amber-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                <span><strong>Missed Dose:</strong> Take as soon as remembered unless close to next dose</span>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="px-8 py-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-blue-100">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-gray-600 text-sm mt-1">{prescriptions.length} active prescriptions</p>
              </div>
                  ...
                  >
                    <td className="px-8 py-6">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="text-sm font-bold text-gray-900">{rx.prescribedBy}</div>
                    ...
                    <td className="px-8 py-6">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm font-semibold text-gray-900">{rx.date}</span>
                      </div>
                    </td>
                    <td className="px-8 py-6">
                      <div className="flex items-center space-x-2">
                        <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                        <span className="text-sm font-semibold text-gray-900">{rx.type}</span>
                      </div>
                    </td>
