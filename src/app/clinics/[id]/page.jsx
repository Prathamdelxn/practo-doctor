...
//   const getWeekdayHours = (openingHours) => {
...
//   const formattedHours = formatOpeningHours(clinic.openingHours)
...
//                     <span className="font-medium">{getWeekdayHours(clinic.openingHours)}</span>
//                   </li>
//                   <li className="flex justify-between">
...
//                   </p>
//                   <p className="text-gray-600 text-sm">{clinic.country}</p>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//                       <p className="text-gray-600">
//                         <span className="block">Weekdays: {getWeekdayHours(clinic.openingHours)}</span>
...
//               >
//                 Services ({clinic.specialties?.length || 0})
//               </button>
//               <button
//                 onClick={() => setActiveTab('hours')}
//                 className={`pb-3 px-4 font-medium text-lg ${activeTab === 'hours' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600 hover:text-blue-600'}`}
//               >
//                 Hours
//               </button>
//                <button
...
'use client'
import { motion } from 'framer-motion'
import { MapPin, Star, Clock, Phone, Mail, Globe, ChevronLeft, HeartPulse, Stethoscope, Pill, User, Award, Calendar } from 'lucide-react'
import { useState, useEffect } from 'react'
import { useRouter } from 'next/navigation'
import Navbar from '@/components/Navbar'
import { useParams } from 'next/navigation';
