...
// // //     { icon: Hospital, label: 'My Hospitals', href: '/doctor-dashboard/hospitals' },
...
// // //             </div>
// // //             <span className="text-white font-bold text-lg">MediCare Pro</span>
// // //           </div>
// // //           <button
// // //             onClick={() => setSidebarOpen(false)}
...
// //   const sidebarItems = [
// //     { icon: Activity, label: 'Overview', href: '/doctor-dashboard', active: true },
// //     { icon: Hospital, label: 'My Hospital', href: '/doctor-dashboard/hospital' },
// //     { icon: Stethoscope, label: 'Doctors', href: '/doctor-dashboard/doctors' },
// //     { icon: UserPlus, label: 'Staff', href: '/doctor-dashboard/staff' },
// //     { icon: Calendar, label: 'Appointments', href: '/doctor-dashboard/appointments' },
// //     { icon: Users, label: 'Patients', href: '/doctor-dashboard/patients' },
// //     { icon: Settings, label: 'Settings', href: '/doctor-dashboard/settings' },
// //   ];
...
// //               <Hospital className="w-5 h-5 text-blue-600" />
// //             </div>
// //             <span className="text-white font-bold text-lg">HealthByte</span>
// //           </div>
// //           <button
// //             onClick={() => setSidebarOpen(false)}
// //             className="lg:hidden text-white hover:bg-white hover:bg-opacity-20 p-1 rounded"
...
// //               <div>
// //                 <p className="font-semibold">Dr. Sarah Johnson</p>
// //                 <p className="text-sm opacity-90">Senior Cardiologist</p>
// //               </div>
// //             </div>
// //           </div>
// //         </div>
...
// //                     <p className="text-xs text-gray-500">Chief of Cardiology</p>
// //                   </div>
// //                   <ChevronDown className="w-4 h-4 text-gray-500" />
// //                 </button>
...
// //                       <p className="text-sm font-medium text-gray-900">Dr. Sarah Johnson</p>
// //                       <p className="text-xs text-gray-500">sarah.johnson@citygeneralhospital.com</p>
// //                     </div>
// //                     <a href="#" className="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-50">
// //                       <User className="w-4 h-4 mr-3" />
// //                       Profile
...
// export default function ClinicDashboardLayout({ children, currentPage = 'overview' }) {
//   const [sidebarOpen, setSidebarOpen] = useState(false);
//   const [profileDropdownOpen, setProfileDropdownOpen] = useState(false);

//   const sidebarItems = [
//     { icon: Activity, label: 'Overview', href: '/clinic-dashboard', id: 'overview' },
//     { icon: Calendar, label: 'Appointments', href: '/doctor-dashboard/appointments', id: 'appointments' },
//     { icon: Users, label: 'Patients', href: '/clinic-dashboard/patients', id: 'patients' },
//     { icon: Clock, label: 'Schedule', href: '/clinic-dashboard/schedule', id: 'schedule' },
//     { icon: FileText, label: 'Medical Records', href: '/clinic-dashboard/records', id: 'records' },
//     { icon: CreditCard, label: 'Billing', href: '/clinic-dashboard/billing', id: 'billing' },
//     { icon: Settings, label: 'Settings', href: '/clinic-dashboard/settings', id: 'settings' },
//   ];
...
//             </div>
//             <span className="text-white font-bold text-lg">HeartCare Clinic</span>
//           </div>
//           <button
//             onClick={() => setSidebarOpen(false)}
//             className="lg:hidden text-white hover:bg-white hover:bg-opacity-20 p-1 rounded"
...
//                   <div className="hidden md:block text-left">
//                     <p className="text-sm font-medium text-gray-900">Dr. Sarah Johnson</p>
//                     <p className="text-xs text-gray-500">HeartCare Clinic</p>
//                   </div>
//                   <ChevronDown className="w-4 h-4 text-gray-500" />
//                 </button>
...
//                     <div className="px-4 py-2 border-b border-gray-100">
//                       <p className="text-sm font-medium text-gray-900">Dr. Sarah Johnson</p>
//                       <p className="text-xs text-gray-500">sarah.johnson@heartcare.com</p>
//                     </div>
//                     <button 
//                       onClick={() => setProfileDropdownOpen(false)}
//                       className="w-full flex items-center px-4 py-2 text-gray-700 hover:bg-gray-50 text-left"
//                     >
//                       <User className="w-4 h-4 mr-3" />
//                       Profile
//                     </button>
//                     <button className="w-full flex items-center px-4 py-2 text-gray-700 hover:bg-gray-50 text-left">
//                       <Settings className="w-4 h-4 mr-3" />
//                       Settings
//                     </button>
//                     <hr className="my-2" />
//                     <button className="w-full flex items-center px-4 py-2 text-red-600 hover:bg-red-50 text-left">
//                       <LogOut className="w-4 h-4 mr-3" />
//                       Sign out
//                     </button>
//                   </div>
...
//         {/* Page content */}
//         <main className="p-6">
//           {currentPage === 'profile' ? <ProfilePage /> : (children || <ProfilePage />)}
//         </main>
//       </div>
//     </div>
//   );
